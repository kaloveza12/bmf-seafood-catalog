...
เว็บไซต์มีหน้าหลังบ้านผ่าน Pages CMS และเก็บเนื้อหาไว้ใน GitHub repository:
...
ภาพเก่าที่มาจาก Google Drive ถูกเก็บในช่องซ่อน `legacySrc` เพื่อรักษาลิงก์เดิมและไม่ให้หลังบ้านฟ้องนามสกุลไฟล์ เมื่ออัปโหลดภาพใหม่ ระบบจะใช้ `src` ก่อนโดยอัตโนมัติ และยังเก็บลิงก์เดิมไว้เป็นสำรอง
